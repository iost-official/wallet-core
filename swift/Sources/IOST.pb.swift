...
public struct TW_IOST_Proto_Signature {
  ...
  /// signature algorithm
  public var algorithm: TW_IOST_Proto_Signature.Algorithm = .unknown
...
extension TW_IOST_Proto_Signature.Algorithm: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [TW_IOST_Proto_Signature.Algorithm] = [
    .unknown,
    .secp256K1,
    .ed25519,
  ]
...
extension TW_IOST_Proto_Signature.Algorithm: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
